...
class CrimesPage extends StatefulWidget {
  const CrimesPage({Key? key}) : super(key: key);

  @override
  State<CrimesPage> createState() => _CrimesPageState();
}

class _CrimesPageState extends State<CrimesPage> {
  late Database db;
  List docs = [];
